...
NewLinkWidget::NewLinkWidget(Layers::LTheme* theme, LAttribute* attr,
	QWidget* parent) :
	m_definition_view{ new DefinitionView() },
	m_attr{ attr },
	QLWidget(parent)
{
	init_layout();
	...
	connect(m_attr_map_view, &AttributeMapView::selected_map_item_changed,
	...
	m_splitter->addWidget(m_definition_view);
...
void NewLinkWidget::init_layout()
{
