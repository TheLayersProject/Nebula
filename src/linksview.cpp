...
LinksView::LinksView(LAttribute* attr, QWidget* parent) :
	m_attr{ attr },
	QWidget(parent)
{
...
void LinksView::update_view()
{
	...
	{
		if (m_attr->parent())
			if (LDefinition* parent_theme_item = dynamic_cast<LDefinition*>(m_attr->parent()))
...
void LinksView::paintEvent(QPaintEvent* event)
{
...
void LinksView::paint_item_text(
	QPainter* painter,
	const QString& text,
	const QRect& item_rect,
	QFont font,
