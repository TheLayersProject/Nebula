...
AttributeEditorGroup::AttributeEditorGroup(
...
void AttributeEditorGroup::add_attribute_editor(
...
void AttributeEditorGroup::init_layout()
{
...
void AttributeEditorGroup::set_collapsed(bool collapsed)
{
	if (collapsed)
	{
		...
		for (AttributeEditor* attribute_editor : m_attribute_editors)
			attribute_editor->hide();
